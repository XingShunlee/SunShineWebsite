#pragma checksum "C:\Users\LeeXingShun\source\repos\ehaikerv202010\Views\ManagerMain\NewGameStrage.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "0f442216cb6d2497eafdcf339ed760a502d1994e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"0f442216cb6d2497eafdcf339ed760a502d1994e", @"/Views/ManagerMain/NewGameStrage.cshtml")]
    ...
    public class Views_ManagerMain_NewGameStrage : global::Microsoft.AspNetCore.Mvc.Razor.RazorPage<ehaiker.GameStrategiesModel>
    {
        ...
        public async override global::System.Threading.Tasks.Task ExecuteAsync()
        {
            ...
            WriteLiteral("\r\n");
            EndContext();
#line 2 "C:\Users\LeeXingShun\source\repos\ehaikerv202010\Views\ManagerMain\NewGameStrage.cshtml"
        ...
        <table class=""table table-hover table-success list-group col-md-12 col-xs-12 col-sm-12"">
            <tbody>
                <tr class=""data-row"" style=""border:1px dotted red;"">
                   ");
            WriteLiteral(@" <td style=""border:2px dotted green;"" class=""data-col"">攻略名称:</td>
            ...
            WriteLiteral(@"   </tr>
                ...
                <tr>
        ");
            WriteLiteral("            <td><span class=\"Title\">游戏类型：</span>");
            EndContext();
            BeginContext(4320, 109, false);
#line 77 "C:\Users\LeeXingShun\source\repos\ehaikerv202010\Views\ManagerMain\NewGameStrage.cshtml"
                                                   Write(Html.DropDownList("GameTypes", ViewData["GameTypes"] as SelectList, "--请选择--", new { @class = "SelectList" }));

#line default
#line hidden
            EndContext();
            BeginContext(4429, 9108, true);
            WriteLiteral(@"</td>
        ...
        var app = new Vue({
            ...
            WriteLiteral(@"{
                    ...
                    if (this.current_index < 0) {
                        this.current_index = 0;
        ");
            WriteLiteral(@"                this.isprevDisable.disabled = true;
                        this.isNextDisable.disabled = false;
                    }
                        ...
                        success: function (arrdata) {
                            if (arrdata != null) {
                                ...
                                $.each(that.imgdata, function (i, item) {
                                    ...
                                    var listr = '<li><a class=""img-a"" href=""javascript:void(0);""><img class=""img"" src=""' + item +
                                        '"" alt="" "" widt");
            WriteLiteral(@"h=200px height=200px  /></a></li>';
                                    $("".popImgWrap"").append(listr);  //动态取数据
                                });
                                //修改弹出位置
