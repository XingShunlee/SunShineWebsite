#pragma checksum "C:\Users\LeeXingShun\source\repos\ehaikerv202010\Views\ManagerMain\NewGameStrage.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5ce5efc8840581961d3969f4442bf39793f87170"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5ce5efc8840581961d3969f4442bf39793f87170", @"/Views/ManagerMain/NewGameStrage.cshtml")]
...
<div style=""margin-top:30px;margin-bottom:10px;"" id=""app"">
    <div class=""box-wrap"">
        ...
        <table class=""table table-hover table-success list-group col-md-12 col-xs-12 col-sm-12"">
            ...
            WriteLiteral("：</span>");
            EndContext();
            BeginContext(4294, 109, false);
#line 76 "C:\Users\LeeXingShun\source\repos\ehaikerv202010\Views\ManagerMain\NewGameStrage.cshtml"
                                                   Write(Html.DropDownList("GameTypes", ViewData["GameTypes"] as SelectList, "--请选择--", new { @class = "SelectList" }));

#line default
#line hidden
            EndContext();
            BeginContext(4403, 9006, true);
            WriteLiteral(@"</td>
                    ...
                    $.each(that.imgdata, function (i, item) {
                        if (that.current_index <= i && i < that.current_index + 4) {
                            var listr = '<li><a class=""img-a"" href=""javascript:void(0);""><img class=""img"" src=""' + item +
                                '"" alt="" "" width=200px height=200px  /></a></li>';
                            $("".popImgWrap");
            WriteLiteral(@""").append(listr);  //动态取数据
                        }
