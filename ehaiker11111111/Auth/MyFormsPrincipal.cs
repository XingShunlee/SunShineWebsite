	...
	where TUserData : class, new()
{
	...
	public static void SignIn(string loginName, TUserData userData, int expiration, bool remeberMe)
	{
		...
		FormsAuthenticationTicket ticket = new FormsAuthenticationTicket(
            2, loginName, DateTime.Now, DateTime.Now.AddDays(1), remeberMe, data);
